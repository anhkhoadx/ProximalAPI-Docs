...
**The API outlined below is V2, with V3 to be released to the private test partners in mid-April, 2014. V3 will be the full REST version scheduled for public launch on May 05, 2014. At this time a developer portal will also be available on the main WirelessRegistry.com website.**
